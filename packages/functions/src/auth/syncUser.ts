...
export const main = async (event: any) => {
  ...
  try {
    ...
    console.log("🟢 Incoming /auth/syncUser body:", body);

    // ✅ The frontend can send `idToken` or we can decode it via authorizer
    ...
    const userItem = {
      ...
      createdAt: Date.now(),
      updatedAt: Date.now(),
      raw: body, // optional — saves full payload for debugging
    };
